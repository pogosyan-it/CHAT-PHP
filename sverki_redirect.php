<html>  <title>Переадресация доставок</title>
<head>  <link rel="shortcut icon" href="dimex.jpg" type="image/x-icon">
<meta http-equiv="content-type" content="text/html; charset=cp1251">
 <link rel="stylesheet" href="stylesverki.css"  type="text/css">
...
border-radius: 5px; box-shadow: 0px 1px 3px; font-size: 17px; text-align: center;" type="submit">Назад</button>
   ...
   <h3><font  color="White"><div align="center" >Переадресация доставок</div></font></h3>
<?php
...
unset($_SESSION['sverki_redirect']);
...
<div id="errorchl"><font size="6" color="red">Некорректно выбран интервал!</font></div>          
 ...
 ?>      
            ...
            <p><font size="4"; color="White">интервал</font></p>
   	<script type="text/javascript" src="tcal.js"></script> 
    <form action="Examples\sverki_redirect_Ex.php" method="post"> 
